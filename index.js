...
function createList() {
	...
	// run locally
    //$.get("http://localhost:7071/api/calvinwritecosmos", function(data, status){ 
    
    
	// run on Azure
    $.get("https://calvincosmosdatawriteinclass.azurewebsites.net/api/calvinwritecosmos", function(data, status){ 
